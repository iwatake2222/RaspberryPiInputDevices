...
private:
    ...
    /* Key */
    const static uint32_t GPIO_KEY0 = 17;
    const static uint32_t GPIO_KEY1 = 27;
    ...
    const static uint32_t GPIO_ROTARY_A = 21;
    const static uint32_t GPIO_ROTARY_B = 20;
    ...
    const static uint32_t ACCEL_I2C_ADDR = 0x53;
